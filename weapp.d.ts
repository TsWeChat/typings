...
declare namespace wx {
    ...
    export interface IPageScrollToOptions {
        /**
		 * 滚动到页面的目标位置（单位px）
		 */
        scrollTop: number
	 ...
	 * 将页面滚动到目标位置
	 */
    export function pageScrollTo(pageScrollToOptions: IPageScrollToOptions): void
    ...
    export const createSelectorQuery: ZeroParamVoidFunc
}
